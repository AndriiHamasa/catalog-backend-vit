...
# ==============================================
STATIC_URL = '/static/'  # ← ВАЖНО: слэш в начале!
STATIC_ROOT = BASE_DIR / 'staticfiles'
...
# ==============================================
# CLOUDINARY SETTINGS (только для MEDIA!)
# ==============================================
import cloudinary
import cloudinary.uploader
import cloudinary.api
...
# Используем Cloudinary ТОЛЬКО для media файлов на продакшене
if RAILWAY_ENVIRONMENT:
    # Переопределяем default storage для media файлов
    STORAGES["default"] = {
